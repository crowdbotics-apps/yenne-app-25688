"""yenne_app_25688 URL Configuration
...
urlpatterns = [
    ...
    path('api/v1/', include([
        path("", include("wallet.api.v1.urls")),
        path("", include("payment.api.v1.urls")),
    ])),
]

admin.site.site_header = "Yenne App"
admin.site.site_title = "Yenne App Admin Portal"
admin.site.index_title = "Yenne App Admin"

# swagger
api_info = openapi.Info(
    title="Yenne App API",
    default_version="v1",
    description="API documentation for Yenne App App",
)
