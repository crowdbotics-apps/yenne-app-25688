...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.View_74_1}>
        <View style={styles.View_74_2} />
        <ImageBackground
          source={{
            uri:
      ...
      />
      <View style={styles.View_74_8}>
        <View style={styles.View_74_9} />
        <View style={styles.View_74_10}>
          <Text style={styles.Text_74_10}>SUBMIT</Text>
        </View>
      </View>
      <View style={styles.View_74_11}>
        <Text style={styles.Text_74_11}>Financial account</Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_74_12}
      />
      <View style={styles.View_74_14}>
        <Text style={styles.Text_74_14}>Add new card</Text>
      </View>
      <View style={styles.View_74_15} />
      <View style={styles.View_74_17} />
      <View style={styles.View_74_18}>
        <Text style={styles.Text_74_18}>Card number</Text>
      </View>
      <View style={styles.View_74_19} />
      <View style={styles.View_74_20} />
      <View style={styles.View_74_21}>
        <Text style={styles.Text_74_21}>CVV</Text>
      </View>
      <View style={styles.View_74_22}>
        <Text style={styles.Text_74_22}>MM YY </Text>
      </View>
      <View style={styles.View_74_23} />
      <View style={styles.View_74_24}>
        <Text style={styles.Text_74_24}>Card holder</Text>
      </View>
      <View style={styles.View_74_41} />
      <View style={styles.View_74_47}>
        <View style={styles.View_74_43} />
        <View style={styles.View_74_44}>
          <Text style={styles.Text_74_44}>
            Would you like to create a business account?
          </Text>
        </View>
        <View style={styles.View_74_48} />
        <View style={styles.View_74_46}>
          <Text style={styles.Text_74_46}>No</Text>
        </View>
        <View style={styles.View_74_45}>
          <Text style={styles.Text_74_45}>Yes</Text>
        </View>
      </View>
