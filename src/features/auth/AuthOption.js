...
GoogleSignin.configure({
  ...
  webClientId:
    '4459140409-btn1nusljjd6s8i2q5ijh35h5ueeib8e.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
  ...
  iosClientId:
    '4459140409-629nbi4cavcvpalgkmv8t00v4bajsm22.apps.googleusercontent.com', // [iOS] optional, if you want to specify the client ID of type iOS (otherwise, it is taken from GoogleService-Info.plist)
